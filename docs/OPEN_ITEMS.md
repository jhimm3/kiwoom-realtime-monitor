...
| D06 | 부분 구현 | `historical_learning_cases/v1`로 사후 후보·복원 뉴스·미생성 AI 해석·미래 결과를 분리한 첫 50사례를 동결. 뉴스 근거 22사례, 결과 2사례이며 모델 학습은 하지 않음. 수집 확대 뒤 사건 중복을 고려한 분할, 사람 검토 정답, RAG와 미세조정 비교·평가, 로컬 LLM/Mac 작업자와 행동 EV 범위 결정이 남음 |
