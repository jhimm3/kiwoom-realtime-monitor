...
| ID | 상태 | 작업·완료 조건 |
|---|---|---|
| D01 | 진행 중 | 삼성전자 1분 최과거→이전 5분 최과거 연속조회 완료. 최신 개수조회 보강·일 단위 경계·구간 종료시각 확인. 후보 전체 확대·재개 원장·누락 확인 |
| D02 | 진행 중 | 날짜 지정 네이버 웹 검색 2020년 표본과 원응답·기사-종목 연결 저장 완료. 과거 원문/발행시각·2년/5년 도달·이용 범위 확인 |
