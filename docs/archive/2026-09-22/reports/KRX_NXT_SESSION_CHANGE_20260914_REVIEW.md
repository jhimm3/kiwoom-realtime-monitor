> **과거 기록** · 원래 경로: `reports/KRX_NXT_SESSION_CHANGE_20260914_REVIEW.md` · [현재 문서](../../../README.md) · 당시 미구현·다음 단계는 현재 상태가 아니다. 원문 바이트는 아카이브 ZIP에 보존했다.
...
- **수정 대상:** 먼저 이 감사 문서의 공식 확인 표와 `docs/archive/2026-09-22/root/API_CONTRACT.md`, `docs/archive/2026-09-22/root/HISTORICAL_DATA_CONTRACT.md`의 예정 계약. 실제 계좌/주문 변경 없음.
...
- `docs/archive/2026-09-22/root/API_CONTRACT.md`: 거래소/phase 근거, capability별 관측·연구·모의 지원 구별. 기존 market_state=지수 의미 유지.
- `docs/archive/2026-09-22/root/HISTORICAL_DATA_CONTRACT.md`, `docs/archive/2026-09-22/root/DB_SCHEMA.md`: 정규장/애프터 자료 범위·완결성·추가 metadata/필요 migration·과거 정책.
- `docs/archive/2026-09-22/root/ARCHITECTURE_CURRENT.md`, `docs/archive/2026-09-22/root/MODULE_MAP.md`: 실제 공통 정책 소유자와 소비 경로.
- `docs/archive/2026-09-22/snapshots/docs/RESEARCH_REQUEST_FORMAT.md`, `docs/archive/2026-09-22/snapshots/docs/FORWARD_EVALUATION_CONTRACT.md`, `docs/archive/2026-09-22/snapshots/docs/KIWOOM_MOCK_EXECUTION_CONTRACT.md`: session profile/결과 동일성/미지원 모의시간.
- `docs/AI_인수인계_개발실행서_v3.3.md:160–176`, `docs/archive/2026-09-22/legacy/키움_실시간_모니터_기술명세서_v2.0.md`: 구독·후속조회 시간표와 공식 종가 설명.
- `docs/archive/2026-09-22/reports/CONTINUOUS_RESEARCH_ACCOUNT_SCOPE_REVIEW.md`, 구현 계획의 A4/CR1~CR4/A5/O2-M: 계좌 원본은 유지하고 시간제도 version 의존성을 연결.
- `docs/archive/2026-09-22/root/CHANGELOG.md`, `docs/archive/2026-09-22/reports/NAS_DEPLOYMENT_PENDING.md`: 구현/테스트/배포/장중 실확인 상태를 구별. 과거 릴리스 당시 시간표는 삭제하지 않고 적용 시기를 명시.
