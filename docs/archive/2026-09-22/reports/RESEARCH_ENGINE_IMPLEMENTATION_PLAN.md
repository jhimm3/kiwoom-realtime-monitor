> **과거 기록** · 원래 경로: `reports/RESEARCH_ENGINE_IMPLEMENTATION_PLAN.md` · [현재 문서](../../../README.md) · 당시 미구현·다음 단계는 현재 상태가 아니다. 원문 바이트는 아카이브 ZIP에 보존했다.
...
| 변경 | 같은 변경에서 갱신 |
|---|---|
| API/필드·인증·오류 | `docs/archive/2026-09-22/root/API_CONTRACT.md` 및 API 회귀 |
| 스키마/소유권·시각·revision/보존 | `docs/archive/2026-09-22/root/DB_SCHEMA.md`, `docs/archive/2026-09-22/root/HISTORICAL_DATA_CONTRACT.md` |
| 모듈 추가/이동 | `docs/archive/2026-09-22/root/MODULE_MAP.md` |
| 실제 동작·사용자 영향 | `docs/archive/2026-09-22/root/ARCHITECTURE_CURRENT.md`, `docs/archive/2026-09-22/root/CHANGELOG.md` |
...
미래 계획을 현재 구조 문서에 완료형으로 쓰지 않는다. 기존 `docs/archive/2026-09-22/root/REFACTORING_CLOSEOUT_PLAN.md`의 완료 단계나 보류 운영 검증을 신규 기능 완료로 변경하지 않는다.
