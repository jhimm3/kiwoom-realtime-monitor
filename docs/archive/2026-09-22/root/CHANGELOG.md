> **정리 전 스냅샷** · 원래 경로: `CHANGELOG.md` · [현재 문서](../../../../CHANGELOG.md) · 원문 바이트는 아카이브 ZIP에 보존했다.
...
- 시점별 시장자료와 향후 시뮬레이션 개발 순서를 `docs/archive/2026-09-22/root/FUTURE_DEVELOPMENT_ROADMAP.md`에 기록했다.
...
- 과거 순위·봉·시장·테마를 시점 기준으로 결합하기 위한 `docs/archive/2026-09-22/root/HISTORICAL_DATA_CONTRACT.md`와 순위 스냅샷·TOP20 코호트 보존 회귀 테스트를 추가했다.
...
- 리팩터링 종료까지 남은 4단계, 현재 단계, NAS 누적 배포 시점과 증거 부족으로 보류한 항목을 `docs/archive/2026-09-22/root/REFACTORING_CLOSEOUT_PLAN.md`에 고정하고 후속 작업이 이 원장을 먼저 확인하도록 했다.
...
- 이전 버전: `docs/archive/2026-09-22/root/README.md`의 변경 내역 참조
