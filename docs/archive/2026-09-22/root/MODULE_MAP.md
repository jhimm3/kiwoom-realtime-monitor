> **정리 전 스냅샷** · 원래 경로: `MODULE_MAP.md` · [현재 문서](../../../../MODULE_MAP.md) · 원문 바이트는 아카이브 ZIP에 보존했다.
...
- 보존 기준과 현재 수집 공백: `docs/archive/2026-09-22/root/HISTORICAL_DATA_CONTRACT.md`
...
과거 시뮬레이션 기능을 수정할 때는 먼저 `docs/archive/2026-09-22/root/HISTORICAL_DATA_CONTRACT.md`에서 원본/파생값, 시점 기준, 누락 의미를 확인한다. 읽기 전용 시뮬레이션 조회 서비스가 생기기 전까지 UI가 저장소 여러 개를 직접 결합하지 않는다.
