> **정리 전 스냅샷** · 원래 경로: `deploy/synology/README.md` · [현재 문서](../../../../../../deploy/synology/README.md) · 원문 바이트는 아카이브 ZIP에 보존했다.
...
누적 배포와 실제 운용 검증 상태는 `docs/archive/2026-09-22/reports/NAS_DEPLOYMENT_PENDING.md`를 따른다.
