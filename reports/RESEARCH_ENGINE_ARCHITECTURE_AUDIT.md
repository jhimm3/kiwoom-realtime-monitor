...
기존 `AGENTS.md`, `DEVELOPMENT_GUARDRAILS.md`, `MODULE_MAP.md`, `FUTURE_DEVELOPMENT_ROADMAP.md`, `REFACTORING_CLOSEOUT_PLAN.md`를 확인했다. 리팩터링은 종료됐으므로 재개할 이유가 없다. NAS 장시간 수집 연속성과 다른 PC 동시 사용은 기존 후속 운영 항목으로 남긴다.
